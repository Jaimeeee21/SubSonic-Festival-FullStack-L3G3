    ...
    if (artistsList) {
        ...
        if (Array.isArray(artists)) {
            ...
            artistsHtml = artists.map((artist) => `
                <div class="artist-list-item">
                    ...
                    <button class="spotify-btn" title="Buscar en Spotify">
        ...
        spotifyBtns.forEach((btn, index) => {
            btn.addEventListener('click', (e) => {
                ...
                const spotifyUrl = `https://open.spotify.com/search/${encodeURIComponent(artistName)}`;
        ...
        ticketsGrid.innerHTML = tickets.map((ticket) => {
            ...
            return `
                <div class="${cardClass}">
                    ...
                    <button class="btn-primary">${escapeHtml(ticket.button)}</button>
                </div>
            `;
        }).join('');
    }
